...
The public folder contains fourteen published DPFs with 243 pattern bodies. Start with the working question nearest to yours. Each linked publication provides its full searchable pattern index.
